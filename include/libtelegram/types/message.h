...
struct message {
  ...
  //types::chat forward_from_chat;                                              // Optional. For messages forwarded from a channel, information about the original channel
  ...
  //types::audio audio;                                                         // Optional. Message is an audio file, information about the file
  //types::document document;                                                   // Optional. Message is a general file, information about the file
  //photo                      Array of PhotoSize                               // Optional. Message is a photo, available sizes of the photo
  //types::sticker sticker;                                                     // Optional. Message is a sticker, information about the sticker
  //types::video video;                                                         // Optional. Message is a video, information about the video
  //types::voice voice;                                                         // Optional. Message is a voice message, information about the file
  std::string caption;                                                          // Optional. Caption for the document, photo or video, 0-200 characters
  //types::contact contact;                                                     // Optional. Message is a shared contact, information about the contact
  //types::location location;                                                   // Optional. Message is a shared location, information about the location
  //types::venue venue;                                                         // Optional. Message is a venue, information about the venue
...
message const message::from_ptree(boost::property_tree::ptree const &tree) {
  ...
  return message{tree.get("message_id", 0),
                 //user::from_ptree(tree, "from"),
                 tree.get("date", 0),
                 chat::from_ptree(tree, "chat"),
                 //user::from_ptree(tree, "forward_from"),
                 //chat::from_ptree(tree, "forward_from_chat"),
                 ...
                 //tree.get("pinned_message     Message };
}
